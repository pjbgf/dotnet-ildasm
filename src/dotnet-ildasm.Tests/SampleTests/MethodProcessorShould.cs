...
namespace DotNet.Ildasm.Tests.SampleTests
{
    public class MethodProcessorShould
    {
        ...
        [InlineData("PublicClass", "PublicVoidMethodTwoParameters", ".method public hidebysig instance void PublicVoidMethodTwoParameters(string parameter1, int parameter2) cil managed")]
